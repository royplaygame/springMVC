...
public class SpringMVCTest {
	...
	public void getUser(@RequestParam(value="id",required=false) Integer id, 
		...
		if(id != null){
			//模拟从数据库中获取对象
			User user = new User(1, "Tom", "123456", "tom@126.com", 16);
	...
	public String testSessionAttributes(Map<String, Object> map){
		User user = new User("Tom", "123456", "tom@126.com", 15);
		map.put("user", user);
		map.put("school", "hpjd");
		return SUCCESS;
	}
	...
	public String testMap(Map<String,Object> map){
		...
		map.put("names",Arrays.asList("Pek","Nathen","Roy","Tom"));
		return SUCCESS;
	}
	...
	public String testRequestHeader(@RequestHeader(value="Accept-Encoding") String aEncode) {
		System.out.println("testRequestHeader, Accept-Encoding: "+aEncode);
		return SUCCESS;
	}
	...
	/**
	 * 1. @RequestMapping 除了修饰方法, 还可来修饰类 1). 类定义处: 提供初步的请求映射信息。相对于 WEB 应用的根目录
